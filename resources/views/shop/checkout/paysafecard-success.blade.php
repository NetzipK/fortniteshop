    ...
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 2rem;">
          <div class="col-md-offset-2 col-md-8">
              ...
              <div>We are now processing your order and are waiting for a verification for your {{ $order->payment_gateway }} payment. You will receive an email with your order details once the verification is finished and successful.</div>
